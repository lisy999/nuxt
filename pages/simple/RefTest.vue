<template>
  <div>
    ...
    <el-button @click="changeName" type="primary">改变姓名</el-button>
    <el-button @click="changeAge" type="primary">增加一岁</el-button>
    <el-button @click="changeAll" type="primary">改变所有</el-button>
    <el-button @click="changeComputed" type="primary">改变计算属性</el-button>
  </div>
</template>
